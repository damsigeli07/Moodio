        ...
        class MoodiO {
            ...
            analyzeTextMood() {
                ...
                const moodKeywords = {
                    happy: ['happy', 'joy', 'excited', 'cheerful', 'elated', 'thrilled', 'upbeat', 'positive', 'great', 'awesome', 'amazing', 'wonderful'],
                    sad: ['sad', 'down', 'depressed', 'melancholy', 'blue', 'upset', 'heartbroken', 'lonely', 'cry', 'tears', 'hurt', 'pain'],
                    energetic: ['energetic', 'pumped', 'active', 'motivated', 'hyped', 'powerful', 'strong', 'workout', 'run', 'exercise', 'boost'],
                    chill: ['chill', 'relaxed', 'calm', 'peaceful', 'laid-back', 'cool', 'zen', 'mellow', 'rest', 'quiet', 'easy', 'smooth'],
                    romantic: ['love', 'romantic', 'affectionate', 'tender', 'sweet', 'loving', 'date', 'heart', 'crush', 'valentine', 'kiss'],
                    nostalgic: ['nostalgic', 'memories', 'past', 'remember', 'miss', 'old times', 'childhood', 'throwback', 'vintage', 'classic']
                };
                ...
                console.log('🤖 AI detected mood:', detectedMood, 'from text:', input);
